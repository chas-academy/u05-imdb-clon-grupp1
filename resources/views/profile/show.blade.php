<x-app-layout>
    ...
    <div class="flex flex-col justify-center items-center">
        ...
        @can('update', $user->profile)
            <div class="flex w-4/5 max-w-screen-xl pb-8">
                <a href="/profile/{{$user->profile->id}}/edit" class="py-2 px-3 rounded-lg bg-indigo-900 text-white transform hover:scale-105">Edit Profile</a>
            </div>
        @endcan
    ...
    <div class="flex justify-center">
        <p class="w-screen max-w-screen-2xl pr-3">
            <a href="/watchlist/{{ auth()->user()->profile->id }}" class="float-right py-2 px-3 rounded-lg bg-indigo-900 text-white transform hover:scale-105">Watchlist</a>
        </p>
    </div>
