                        ...
                        <tbody class="text-white">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-800">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <div class="mr-2">
                                            <img class="w-6 h-6 rounded-full" src="{{ $user->profile->profileImage() }}" />
                                        </div>
                                        <span>{{ $user->name }}</span>
                                    </div>
                                </td>
                    ...
                    <table class="border-solid border-4 min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-left">Date Added</th>
                                <th class="py-3 px-6 text-center">Actions</th>
                            </tr>
                        </thead>
                        <tbody class="text-white">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-800">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <div class="mr-2">
                                            <img class="w-6 h-6 rounded-full" src="{{ $review->user->profile->profileImage() }}" />
                                        </div>
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <a href="movies/{{ $review->movies_id }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                                </svg>
                    ...
                    <table class="border-solid border-4 min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-left">Top Rating</th>
                                <th class="py-3 px-6 text-left">Date Added</th>
                                <th class="py-3 px-6 text-center">Actions</th>
                            </tr>
                        </thead>
