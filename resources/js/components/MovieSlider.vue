        ...
        >
                <slide v-for="(movie, index) in moviesPrint" :key="index" class="relative">
                    <div class="m-2 h-72 rounded-3xl relative ">
                        <a :href="'/movies/' + movie.id" v-on:click="search()"><img :src="'/storage/' + movie.img_path" class="z-negative h-full w-full rounded-3xl cursor-pointer object-cover shadow-md border-r border-gray-700 border-opacity-30"></a>
                        ...
                        <div class="gradient absolute w-full h-full top-0 rounded-3xl opacity-0 hover:opacity-100 transition-opacity duration-500">
