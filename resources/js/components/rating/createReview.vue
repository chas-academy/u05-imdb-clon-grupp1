      ...
      <div class="col-md-8">
        <div class="card">
           <form
            ...
            <a :href="'/movies/' + movie.id" class="bg-indigo-900 text-white py-2 px-4 ml-3 rounded-lg mt-5 block transform hover:scale-105 focus:outline-none">Back</a>
            </div>
          </form>
        </div>
      </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            axios.post(uri, { review, rating,}).then((response) => {
